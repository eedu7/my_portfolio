...
const HeroSection = () => {
    return (
        <section
            className="relative h-[500px] overflow-hidden rounded-lg bg-background">
            <div
                className="w-full z-10 h-full md:grid grid-cols-2 content-center mt-24 md:mt-0">
                <div className="col-span-1 flex flex-col justify-center items-center mx-4">
                    ...
                    <p className="z-10 whitespace-pre-wrap text-left text-lg w-full font-mono tracking-wide mt-6 text-gray-400 dark:text-white">I
                        specialized in developing scalable backend services.</p>
                </div>
                <div className="col-span-1 w-full h-full flex items-center justify-center pb-40 md:pb-0">
                    <Image src={HeroSectionImage} alt='HeroSection Section Image'
